...
export function ChatInterface() {
    ...
    // Use refs so the transport's prepare callback always reads the latest values
                            ...
                            <div className="flex-1 overflow-y-auto px-6 py-6">
                                {isEmpty ? (
                                        <div className="flex flex-col items-center justify-center h-full gap-4 text-center">
                                                                ...
                                                                <div>
                                                                                            <img src="/images/DISHIO-LOGOTYPE-YELLOW.png" alt="Dishio" className="h-6 w-auto object-contain mx-auto mb-4 opacity-50" />
                                                                                            ...
                                                                                            <p className="text-sm text-neutral-500 mt-2 max-w-[280px] mx-auto leading-relaxed">
                                                                                                {selectedClient ? 'Ask anything or use an action preset below.' : 'Select a client to begin, then start chatting.'}
                                                                                                </p>p>
                                                                </div>div>
                                        </div>div>
                                    ) : (
                                                                                                                    ...
                                                                                                                    <motion.div
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    : 'bg-neutral-900 border border-neutral-800 text-neutral-200 rounded-bl-sm'
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        {msg.role === 'assistant' ? (
                                                                                                                                                                                                                                                                                                                <div className="prose prose-invert prose-sm max-w-none">
                                                                                                                                                                                                                                                                                                                                                                        <ReactMarkdown>{textContent}</ReactMarkdown>ReactMarkdown>
                                                                                                                                                                                                                                                                                                                                                                    </div>div>
                                                                                                                                                                                                                                                                                                            ) : (
                                                                                                                                                                                                                                                                                                                textContent
                                                                                                                                                                                                                                                                                                            )}
                                                                                                                        ...
                                                                                                                        {msg.role === 'assistant' && sources.length > 0 && (
                                                                                                                                                                                                            <div className="ml-10 flex flex-wrap gap-2 mt-1">
                                                                                                                                                                                                                                                            <p className="text-[10px] text-neutral-600 font-bold uppercase tracking-widest w-full mb-1">Context Sources:</p>p>
